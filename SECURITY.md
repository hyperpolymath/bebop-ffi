...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/bebop-ffi/security/advisories/new)
...
- This repository (`hyperpolymath/bebop-ffi`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/bebop-ffi/security/advisories)
...
When using bebop-ffi, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/bebop-ffi/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/bebop-ffi/security/advisories/new) or jonathan.jewell@gmail.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/bebop-ffi/discussions) |
...
*Thank you for helping keep bebop-ffi and its users safe.* 🛡️
