...
[arabic]
. Navigate to
https://github.com/hyperpolymath/bebop-ffi/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/bebop-ffi/security/advisories[Security
Advisories]
...
|*Security issues*
|https://github.com/hyperpolymath/bebop-ffi/security/advisories/new[Report
via GitHub] or jonathan.jewell@gmail.com

|*General questions*
|https://github.com/hyperpolymath/bebop-ffi/discussions[GitHub
Discussions]
...
_Thank you for helping keep bebop-ffi and its users safe._ 🛡️
